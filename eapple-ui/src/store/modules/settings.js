...
const { sideTheme, backgroundMode, sidebarColorMode, tableHeaderColor, showSettings, navType, sidebarSortMode, sidebarCustomOrder, tagsView, tagsViewPersist, tagsIcon, tagsViewStyle, fixedHeader, sidebarLogo, dynamicTitle, footerVisible, footerContent } = defaultSettings
...
const state = {
  ...
  sidebarColorMode: storageSetting.sidebarColorMode || sidebarColorMode,
  tableHeaderColor: storageSetting.tableHeaderColor || tableHeaderColor,
